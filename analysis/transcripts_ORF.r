...
test <- read.table(file="protein_coding_transcript.dat",sep="\t",col.names=c("ID","mRNA","ORF","Fickett","Hexamer"))
...
write.table(output,file="protein_coding_transcript",quote=F,sep="\t",row.names=ID)
