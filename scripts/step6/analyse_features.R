...
stat_lncRNA_unknown <- c(sum(table_unknown$lncRNA_pot == "Yes"),
                         sum(table_unknown$lncRNA_pot == "Yes" & !is.na(table_unknown$pval)),
                         sum(table_unknown$lncRNA_pot == "Yes" & !is.na(table_unknown$pval) & table_unknown$single_exon == "Yes"))
...
stat_high_conf_PC <- c(length(table_high_conf_PC), 
...
table_high_conf_lncRNA <- table_unknown[table_unknown$TSS == "Yes" & 
                                        table_unknown$polyAsite == "Yes" & 
                                        table_unknown$lncRNA_pot == "Yes", ]

stat_high_conf_lncRNA <- c(length(table_high_conf_lncRNA), 
