...
target_id	length	eff_length	est_counts	tpm' temp.tsv.sorted > temp.tsv	
	...
	LANG=en_EN join --header -1 1 -2 1 $HOME/analysis/transcripts_genes_id.tsv.sorted temp.tsv | awk 'BEGIN{OFS="\t"}{print $1,$2,$3,$4,$5,$6,$7,$8}' > $HOME/analysis/abundance/${file_id}/${file_id}_final_abundance.tsv
